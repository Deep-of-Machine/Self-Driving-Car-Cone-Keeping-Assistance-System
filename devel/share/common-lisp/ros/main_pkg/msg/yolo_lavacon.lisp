...
(cl:defmethod cl:initialize-instance :after ((m <yolo_lavacon>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'yolo_lavacon)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main_pkg-msg:<yolo_lavacon> is deprecated: use main_pkg-msg:yolo_lavacon instead.")))

(cl:ensure-generic-function 'yolo_mid_X-val :lambda-list '(m))
(cl:defmethod yolo_mid_X-val ((m <yolo_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:yolo_mid_X-val is deprecated.  Use main_pkg-msg:yolo_mid_X instead.")
  (yolo_mid_X m))

(cl:ensure-generic-function 'yolo_mid_y-val :lambda-list '(m))
(cl:defmethod yolo_mid_y-val ((m <yolo_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:yolo_mid_y-val is deprecated.  Use main_pkg-msg:yolo_mid_y instead.")
  (yolo_mid_y m))

(cl:ensure-generic-function 'yolo_con_name-val :lambda-list '(m))
(cl:defmethod yolo_con_name-val ((m <yolo_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:yolo_con_name-val is deprecated.  Use main_pkg-msg:yolo_con_name instead.")
  (yolo_con_name m))

(cl:ensure-generic-function 'yolo_con_color-val :lambda-list '(m))
(cl:defmethod yolo_con_color-val ((m <yolo_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:yolo_con_color-val is deprecated.  Use main_pkg-msg:yolo_con_color instead.")
  (yolo_con_color m))
