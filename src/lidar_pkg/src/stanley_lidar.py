...
class StanleyController:
    ...
    def control(self):
        ...
        third_closest_idx = sorted_indices[3]  # 3번째로 가까운 점의 인덱스
        closest_point = self.midpoints[closest_idx]
        ...
        x_error = lookahead_point[1] - self.vehicle_pos[0]
        ...
        steering_angle = path_yaw + np.arctan2(self.k * x_error, speed_for_calculation)
