...
(cl:defmethod cl:initialize-instance :after ((m <lidar_lavacon>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_lavacon)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main_pkg-msg:<lidar_lavacon> is deprecated: use main_pkg-msg:lidar_lavacon instead.")))

(cl:ensure-generic-function 'lidar_mid_X-val :lambda-list '(m))
(cl:defmethod lidar_mid_X-val ((m <lidar_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:lidar_mid_X-val is deprecated.  Use main_pkg-msg:lidar_mid_X instead.")
  (lidar_mid_X m))

(cl:ensure-generic-function 'lidar_mid_y-val :lambda-list '(m))
(cl:defmethod lidar_mid_y-val ((m <lidar_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:lidar_mid_y-val is deprecated.  Use main_pkg-msg:lidar_mid_y instead.")
  (lidar_mid_y m))

(cl:ensure-generic-function 'lidar_mid_z-val :lambda-list '(m))
(cl:defmethod lidar_mid_z-val ((m <lidar_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:lidar_mid_z-val is deprecated.  Use main_pkg-msg:lidar_mid_z instead.")
  (lidar_mid_z m))

(cl:ensure-generic-function 'lidar_con_name-val :lambda-list '(m))
(cl:defmethod lidar_con_name-val ((m <lidar_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:lidar_con_name-val is deprecated.  Use main_pkg-msg:lidar_con_name instead.")
  (lidar_con_name m))

(cl:ensure-generic-function 'lidar_con_color-val :lambda-list '(m))
(cl:defmethod lidar_con_color-val ((m <lidar_lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:lidar_con_color-val is deprecated.  Use main_pkg-msg:lidar_con_color instead.")
  (lidar_con_color m))
