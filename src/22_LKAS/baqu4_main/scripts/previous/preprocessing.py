...
def preprocessing(img, low_threshold, high_threshold, kernel_size): #640*360
    ...
    lower_blue = (110-5, 120, 10) # hsv 이미지에서 바이너리 이미지로 생성 , 적당한 값 30
    upper_blue = (110+5, 255, 255)

    lower_red = (6-6, 120, 30) # hsv 이미지에서 바이너리 이미지로 생성 , 적당한 값 30
    upper_red = (6+4, 255, 255)

    lower_yellow = (19-4, 120, 30) # hsv 이미지에서 바이너리 이미지로 생성 , 적당한 값 30
    upper_yellow = (19+4, 255, 255)
