...
(cl:defmethod cl:initialize-instance :after ((m <lavacon>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lavacon)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main_pkg-msg:<lavacon> is deprecated: use main_pkg-msg:lavacon instead.")))

(cl:ensure-generic-function 'con_mid_X-val :lambda-list '(m))
(cl:defmethod con_mid_X-val ((m <lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:con_mid_X-val is deprecated.  Use main_pkg-msg:con_mid_X instead.")
  (con_mid_X m))

(cl:ensure-generic-function 'con_mid_y-val :lambda-list '(m))
(cl:defmethod con_mid_y-val ((m <lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:con_mid_y-val is deprecated.  Use main_pkg-msg:con_mid_y instead.")
  (con_mid_y m))

(cl:ensure-generic-function 'con_mid_z-val :lambda-list '(m))
(cl:defmethod con_mid_z-val ((m <lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:con_mid_z-val is deprecated.  Use main_pkg-msg:con_mid_z instead.")
  (con_mid_z m))

(cl:ensure-generic-function 'con_name-val :lambda-list '(m))
(cl:defmethod con_name-val ((m <lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:con_name-val is deprecated.  Use main_pkg-msg:con_name instead.")
  (con_name m))

(cl:ensure-generic-function 'con_color-val :lambda-list '(m))
(cl:defmethod con_color-val ((m <lavacon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_pkg-msg:con_color-val is deprecated.  Use main_pkg-msg:con_color instead.")
  (con_color m))
